...
%% Q1.3.a) Q1.3.c)
[h, status1] = getHomographyMatrix(x1, y1, x2, y2, 'RANSAC', 10000);
...
[HA, HD] = getHomoAccuracy([x2; y2], transPoints([1,2], :));

% Draw the projected point back to image 1
figure;
imshow(imageName2);
title('Projected figure from image 1 to image 2');
hold on;
...
[F,inliersIndex] = getFundamentalMatrix([x1', y1'],[x2', y2'], 'RANSAC', 10000);
...
[t1, t2] = estimateUncalibratedRectification(F,[x1', y1'], [x2', y2'], size(imgExample1));
[I1Rect,I2Rect] = rectifyStereoImages(imgExample1,imgExample2,t1,t2);
figure;
